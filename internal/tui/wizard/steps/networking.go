	...
	Sections: []wizard.SectionDefinition{
		...
		},
		{
			...
			Fields: []wizard.FieldDefinition{
				...
				},
				{
					...
					Label:     "host prefix",
					Default:   "23",
					Help:      "subnet size per node (23 = 512 pods/node)",
					Required:  true,
					Validate:  config.ValidateHostPrefix,
		...
		},
		{
			...
			Fields: []wizard.FieldDefinition{
				...
				{
					Key:      "custom_domain",
					Label:    "custom apps domain",
					Default:  "",
					Help:     "optional domain for a second ingress router (e.g., apps.example.com)",
