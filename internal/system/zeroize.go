...
// Scaffolding (smell:04f0e35f): kept as the canonical byte-buffer
// complement to ProxmoxCredentials.Zeroize so all credential-zeroize
// sites share a symmetric vocabulary rather than inlining clear().
