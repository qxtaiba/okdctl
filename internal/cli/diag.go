...
This bundle was automatically sanitized: environment variable values
matching PASSWORD, PASSWD, TOKEN, SECRET, or CREDENTIAL are masked as
'***', and Proxmox credential fields in the config file are zeroed
before marshalling. It is safe to attach to a public issue or paste
into a bug report.
